    ...
    fn poll(self: Pin<&mut Self>, cx: &mut Context<'_>) -> Poll<Self::Output> {
        ...
        loop {
            *this.st = match this.st {
                ...
                State::Stop => {
                    return Poll::Ready(
                        ready!(inner.io.poll_shutdown(cx)).map_err(geario::util::dyn_rc_err),
                    );
                }
            }
        }
    ...
    Err: ResponseError + 'static,
{
    ...
    fn send_response(&mut self, mut msg: Response<()>, body: ResponseBody<B>) -> State<F, B, Err> {
        ...
        {
            msg.head_mut()
                .set_connection_type(crate::ConnectionType::Close);
        }
...
use geario::util::time::sleep;
        ...
        B: MessageBody + 'static,
    {
        ...
        geario::rt::spawn(Dispatcher::new(
            0,
